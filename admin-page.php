  ...
  <body>
      ...
      <div class="wrapper">
        ...
        <aside id="left-sidebar-nav">
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Plant Menu</a>
            </li>
            <li class="no-padding">
            ...
            <div class="container">
              <div class="row">
                <div class="col s12 m12 l12">
                  <h5 class="breadcrumbs-title">Plant Menu</h5>
                </div>
              </div>
            </div>
          </div>
            ...
            <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
              <div class="row">
                <div class="col s12 m4 l3">
                  <h4 class="header">Order Plant</h4>
                </div>
                <div>
                  <table id="data-table-admin" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      while ($row = mysqli_fetch_array($result)) {
                        echo '<tr>';
                        if ($row["productImage"] != NULL && $row["productImage"] != '0') {
                          echo '<td><img src="routers/uploads/' . $row["productImage"] . '" class="thumbnail"></td>';
                        } else {
                          echo '<td><img src="images/noImage.jpg" class="thumbnail"></td>';
                        }
              ...
              <div class="row">
                ...
                <div>
                  <table>
                    <thead>
                      <tr>
                        <th data-field="imageUpload">Plant Image</th>
                    ...
                    <tbody>
                      ...
                      echo '<input id="imageUpload" name="imageUpload" type="file" data-error=".errorTxt01"></td>';
                      echo '<td><div class="input-field col s12"><label for="name">Name</label>';
    ...
    <footer class="page-footer">
      <div class="footer-copyright">
        <div class="container">
          <span>Copyright © 2023 Vaishanavi Patil. All rights reserved.</span>
          <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#"> Vaishanavi Patil.</a></span>
        </div>
      </div>
    </footer>
    <!-- END FOOTER -->
