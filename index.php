      ...
      <div class="wrapper">
        ...
        <aside id="left-sidebar-nav">
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Plant</a>
            </li>
            <li class="no-padding">
        ...
        <section id="content">
          ...
          <!--start container-->
          <div class="container">
            <p class="caption">Order your Plant here.</p>
